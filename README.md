...
```javascript
afinn111 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-afinn-111@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-afinn-111@v0.2.3-umd/browser.js"></script>
```
